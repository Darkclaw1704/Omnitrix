...
public class Ninja extends ImageView implements Serializable {
    ...
    final double x = this.getTranslateY();
    final double y= this.getFitHeight();
...
//        tt.setNode(this);
//        System.out.println(game.rpg.getSecondPillar().getX()+this.getX());
...
//            tt.setToX(game.getGd().getSpacer2().getWidth()+game.rpg.getSecondPillar().getWidth());
